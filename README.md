...
/Docs: Contains the ERD and Relational Model diagrams.

/Scripts: SQL files for table creation, constraints, and triggers.

/Dashboard: Design assets or queries related to the reporting layer.
